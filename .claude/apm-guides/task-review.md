# APM Auto 1.0.0 - Task Review Guide
...
- If the subagent needs to retry with refined instructions, create a follow-up Task Prompt per `.claude/apm-guides/task-assignment.md` §3.4 Follow-Up Task Prompt Construction. If the subagent also left changes uncommitted, note this in the follow-up instructions.
...
2. Investigate and determine outcome per §2.2 Review Outcome Standards:
   ...
   - If a follow-up is needed (including drift correction), create a follow-up Task Prompt per `.claude/apm-guides/task-assignment.md` §3.4 Follow-Up Task Prompt Construction and continue to step 3.
